...
<div class="w3-content w3-container w3-padding-64" data-aos="fade-up" id="contact">
  ...
  <p class="w3-center">
    <em>
      Также Вы можете связаться с нами через форму ниже или написать нам в наших социальных сетях
    </em>
  </p>
  ...
  <div class="w3-row w3-padding-32 w3-section " data-aos="fade-up">
    <div class="w3-content w3-container w3-center">
      ...
      <p class="w3-center">
        <em>
          Не забудьте подписаться на наши профили в социальных сетях.
          Здесь Вы можете узнать о событиях происходящих в команде, турнирах, сборах, а также лучше узнать команду и
          игроков.
        </em>
      </p>
